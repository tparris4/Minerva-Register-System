   ...
   if ($result = mysqli_query($conn, $sql)){
    ...
    $rownumber = $rownumber + 1;
      ...
      while($row = mysqli_fetch_array($result)){
        ...
        echo "<td><form method='POST' action='medicalcoursesearch.php'><input type='hidden' name='addc'  value='".$row['Course_ID']."'><input type='hidden' name='add'  value='".$row['S_Section_ID']."'><input type='submit' name='addcourse' value='Add'></form></td>";
