...
CREATE TABLE IF NOT EXISTS `Register_System`.`Student` (
  ...
  PRIMARY KEY (`Stud_ID`, `S_Last`, `S_First`, `S_Email`, `S_PhoneNum`, `S_HomeAdd`, `S_Username`, `S_Password`, `S_Enroll`, `Facu_ID`),
...
CREATE TABLE IF NOT EXISTS `Register_System`.`Researcher` (
  ...
  PRIMARY KEY (`Resea_ID`, `R_First`, `R_Last`, `R_Email`, `R_PhoneNum`, `R_HomeAdd`, `R_Username`, `R_Password`),
