...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2019 at 05:49 PM
...
CREATE TABLE `attendance` (
  ...
  `SemesterYearID` int(55) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `attendance` (`Att_Sec_ID`, `Date`, `IsPresent`, `A_StudId`, `Facu_ID`, `SemesterYearID`) VALUES
(1001, '09/21/2018', 'Yes', 2222, 0, 0),
(1001, '09/18/2019', 'Y', 2222, 22223, 0),
(1001, '10/20/2019', 'y', 2222, 22223, 50001),
(1001, '10/20/2019', 'y', 2222, 22223, 50001),
(1001, '10/20/2019', 'y', 2222, 22223, 50001),
(1001, '10/20/2019', 'y', 2222, 22223, 50001),
(1001, '', 'Yes', 33332, 22223, 50003),
(1001, '', '', 33332, 22223, 50003),
(1001, '', '', 33390, 22223, 50003);
...
INSERT INTO `enrollment1` (`Stud_ID`, `E_Sec_ID`, `Assignment`, `Grade`, `E_SemesterYearID`, `Facu_ID`, `Date`) VALUES
(2222, 1009, '0', 0, 5004, 0, ''),
(2222, 1009, 'Quiz', 75, 50001, 0, ''),
(2222, 1009, 'Quiz', 75, 50001, 22223, ''),
(2222, 1001, 'Test', 75, 50001, 22223, ''),
(2222, 1009, 'Exam', 80, 50003, 22224, '10/11/2019'),
(2222, 1001, 'Quiz 2', 75, 50003, 22223, '10/11/2019'),
(2222, 1001, 'Quiz', 75, 50003, 22223, '10/20/2019'),
(2222, 1001, '', 0, 50003, 22223, ''),
(33332, 1001, '', 0, 50003, 22223, ''),
(33390, 1001, '', 0, 50003, 22223, '');
...
CREATE TABLE `message` (
  `Send_E_Add` varchar(100) NOT NULL,
...
INSERT INTO `message` (`Send_E_Add`, `Subject`, `Email_Address`, `Message`, `Date`) VALUES
('brandt1988@msc.com', 'test', 'test', 'test', '0000-00-00 00:00:00'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '0000-00-00 00:00:00'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '0000-00-00 00:00:00'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '0000-00-00 00:00:00'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '0000-00-00 00:00:00'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '0000-00-00 00:00:00'),
...
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '0000-00-00 00:00:00'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '0000-00-00 00:00:00'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '2019'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '2019'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', 'test', '2019'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', '', '2019'),
('brandt1988@msc.com', 'test', 'brandt1988@msc.com', '', '2019-12-08 22:26:58pm');
...
(20000, 'test', 'test', 'test', 'test', 'test', 'test2'),
...
ALTER TABLE `attendance`
  ...
  ADD CONSTRAINT `attendance_ibfk_2` FOREIGN KEY (`SemesterYearID`) REFERENCES `masterschedule` (`SemesterYear_ID`),
  ADD CONSTRAINT `attendance_ibfk_3` FOREIGN KEY (`Att_Sec_ID`) REFERENCES `section` (`S_Section_ID`);
