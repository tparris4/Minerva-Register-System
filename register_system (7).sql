...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2019 at 08:06 AM
...
(33332, 'Business'),
(33333, 'Business'),
(33336, 'Medical Chemistry '),
(33337, 'Computer Engineering '),
(33348, 'Business Leadership'),
(33353, 'Human Systems'),
(33357, 'Accounting '),
(33361, 'Digital Art '),
(33368, 'Mathematical Theory '),
(33371, 'Computer Engineering '),
(33379, 'Mathematical Theory');
...
INSERT INTO `prerequisites` (`Prereq_ID`, `P_Course_ID`) VALUES
(90001, 90004),
(90004, 90007);
...
(33335, 'Calculus'),
(33338, 'Biogenetics'),
(33339, 'Graphic Design'),
(33340, 'Computer Science B.A.'),
(33341, 'Computer Science B.A.'),
(33342, 'Computer Science B.S.'),
(33343, 'Graphic Design'),
(33344, 'Digital Art'),
(33345, 'Biochemistry'),
(33346, 'Biogenetics'),
(33347, 'Trigonometry '),
...
(33350, 'Economics'),
(33351, 'Accounting'),
(33352, 'Computer Science B.S.'),
(33354, 'Graphic Design '),
(33355, 'Digital Art'),
(33356, 'Economics '),
(33358, 'Computer Science B.A.'),
(33359, 'Biochemistry '),
(33360, 'Business '),
(33362, 'Accounting '),
(33363, 'Economics '),
(33364, 'Computer Science B.S.'),
(33365, 'Digital Art'),
(33366, 'Graphic Design '),
(33367, 'Digital Art '),
(33369, 'Economics '),
(33370, 'Computer Science B.A.'),
(33372, 'Accounting '),
(33373, 'Calculus '),
(33374, 'Biogenetics '),
(33376, 'Biochemistry '),
(33377, 'Computer Science B.A. '),
(33378, 'Calculus '),
(33380, 'Biochemistry '),
(33381, 'Trigonometry '),
(33382, 'Accounting '),
...
ALTER TABLE `prerequisites`
  ...
  ADD KEY `prereq_idc` (`P_Course_ID`);
...
ALTER TABLE `prerequisites`
  ...
  ADD CONSTRAINT `prereq_idc` FOREIGN KEY (`P_Course_ID`) REFERENCES `course` (`Course_ID`);
