...
?>
 ...
 <?php
     ...
     if(isset($_POST['addgrade'])){
      ...
      if(isset($_POST['addmidfin'])){
         $_SESSION['addmidf'] = $_POST['addmf'];
...
GROUP BY facuschedule.Facu_sec_id ";
        ...
        echo "<td><form method='POST' action='addtoclass.php'><input type='hidden' name='addc'  value='".$row['Course_ID']."'><input type='hidden' name='addmf'  value='".$row['S_Section_ID']."'><input type='submit' name='addmidfin' value='Add Midterm/Final'></form></td>";
