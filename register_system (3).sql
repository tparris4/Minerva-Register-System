...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2019 at 09:14 PM
...
INSERT INTO `course` (`Course_ID`, `C_Name`, `C_Description`, `S_CRN`, `C_CreditAmt`, `CDeptID`, `C_DeptName`, `CourseLevel`) VALUES
...
INSERT INTO `prerequisite` (`Prereq_ID`, `P_CourseID`) VALUES
(3000, 90001);
...
(1001, 22223, 90000, 77771, 50001, 10001, 88810, 0);
...
ALTER TABLE `prerequisite`
  ...
  ADD KEY `pre_cour_id` (`P_CourseID`);
...
--
ALTER TABLE `prerequisite`
  ADD CONSTRAINT `pre_cour_id` FOREIGN KEY (`P_CourseID`) REFERENCES `course` (`Course_ID`);
